...
//		   HttpsURLConnection.setDefaultHostnameVerifier(hv);
		   ...
		   PrintWriter out = new PrintWriter(httpConn.getOutputStream());
		    ...
		    this.salesorderid = "salesorderid="+URLEncoder.encode(((salesorderid==null||salesorderid==""||salesorderid=="NULL")?"NULL":"\""+salesorderid+"\""),"UTF-8");
