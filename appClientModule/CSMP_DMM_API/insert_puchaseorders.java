...
public class insert_puchaseorders {
	...
	private String requisition_no=null ;
...
//		   HttpsURLConnection.setDefaultHostnameVerifier(hv);
		   ...
		   PrintWriter out = new PrintWriter(httpConn.getOutputStream());
		    ...
		    this.requisition_no = "requisition_no="+URLEncoder.encode(((requisition_no==null||requisition_no==""||requisition_no=="NULL")?"NULL":"\""+requisition_no+"\""),"UTF-8");
		    this.tracking_no = "tracking_no="+URLEncoder.encode(((tracking_no==null||tracking_no==""||tracking_no=="NULL")?"NULL":"\""+tracking_no+"\""),"UTF-8");
		    ...
		    this.postatus = "postatus="+URLEncoder.encode(((postatus==null||postatus==""||postatus=="NULL")?"NULL":"\""+postatus+"\""),"UTF-8");
